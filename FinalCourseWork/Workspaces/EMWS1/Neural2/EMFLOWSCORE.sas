...
END;
*** *****************************;
*** Writing the Residuals  of the Node ORGYN ;
*** ******************************;
IF MISSING( ORGYN1 ) THEN R_ORGYN1  = . ;
ELSE R_ORGYN1  = ORGYN1  - P_ORGYN1 ;
IF MISSING( ORGYN0 ) THEN R_ORGYN0  = . ;
ELSE R_ORGYN0  = ORGYN0  - P_ORGYN0 ;
*** *************************;
